  ...
  return (
    <div className="fixed bottom-6 sm:bottom-10 left-1/2 z-[100] -translate-x-1/2 pointer-events-none">
      <motion.nav
        ...
        className="glass-panel-strong pointer-events-auto flex items-center gap-3 sm:gap-5 rounded-full px-5 py-4 border-t border-primary/30 shadow-[0_20px_50px_rgba(0,0,0,0.8),inset_0_1px_5px_rgba(255,255,255,0.1),0_0_20px_rgba(99,102,241,0.2)]"
      >
        {navItems.map((item) => (
          <motion.a
            key={item.name}
            ...
            whileTap={{ scale: 0.9 }}
            className="group relative flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-white/5 border border-white/10 text-slate-300 transition-colors hover:bg-primary/20 hover:border-primary/50 hover:text-primary hover:shadow-[0_0_15px_rgba(99,102,241,0.5)]"
          >
